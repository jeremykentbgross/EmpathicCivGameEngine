...
GameEngineLib.EntityComponent_Sprite = function EntityComponent_Sprite()
{
...
GameEngineLib.EntityComponent_Sprite.prototype.constructor = GameEngineLib.EntityComponent_Sprite;



GameEngineLib.EntityComponent_Sprite.prototype.init = function()
{
	//var i = 0;
...
GameEngineLib.EntityComponent_Sprite.prototype.render = function(inCanvasContext, inCameraPoint)
{
...
GameEngineLib.EntityComponent_Sprite.prototype.onAddedToEntity = function(inEntity)
{
...
GameEngineLib.EntityComponent_Sprite.prototype.onRemovedFromEntity = function()
{
...
GameEngineLib.EntityComponent_Sprite.prototype.onUpdatePosition = function(inEvent)
{
...
GameEngineLib.EntityComponent_Sprite.prototype.onAddedToWorld = function(inEvent)
{
	this._world = inEvent.world;
	this._world.getSceneGraph().insertItem(this._sceneGraphRenderable);
}
GameEngineLib.EntityComponent_Sprite.prototype.onRemovedFromWorld = function(inEvent)
{
	this._world.getSceneGraph().removeItem(this._sceneGraphRenderable);
	this._world = null;
}

GameEngineLib.EntityComponent_Sprite.prototype.destroy = function(){}//TODO
GameEngineLib.EntityComponent_Sprite.prototype.serialize = function(){}//TODO