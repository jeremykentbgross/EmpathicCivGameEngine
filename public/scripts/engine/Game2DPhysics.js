...
ECGame.EngineLib.createGame2DPhysics = function()
{
	...
	outGame2DPhysics.init = function(inWorldSize, inMinSize)
	{
		...
		myDetectionTree.init(
			ECGame.EngineLib.Game2DAABB.create(0, 0, inWorldSize, inWorldSize),
			inMinSize
		);
	...
	outGame2DPhysics.createNewPhysicsObject = function()
	{
		...
		physicsObject = 
		{
			...
			//myFriction:,??
			AABB : ECGame.EngineLib.Game2DAABB.create(),//todo have lots of gamerects relative to a center??
